...
write.csv(envTukey, file = "01_summary_envdata_out/01_Tukey_envdata.csv", quote = F)
saveRDS(tbl_formatted, file = "01_summary_envdata_out/01_envdata_meansd_table_w_2way.obj")
tbl_formatted |> 
  gtsave(filename = "01_summary_envdata_out/01_envdata_meansd_table_w_2way.tex")
tbl_formatted |> 
  gtsave(filename = "01_summary_envdata_out/01_envdata_meansd_table_w_2way.docx")
tbl_formatted |> 
  gtsave(filename = "01_summary_envdata_out/01_envdata_meansd_table_w_2way.html")
