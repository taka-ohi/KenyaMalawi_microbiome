...
### save data
# create a directory
dir.create("FigCode/FigM_correlation_btw_heterogeneity_out")
...
for (i in 1:10) {
  saveRDS(ws_plots[[i]],
          file = sprintf("FigCode/FigM_correlation_btw_heterogeneity_out/cor_%s_within.obj",
                         ws.pairs$filename[i]))
  ggsave(ws_plots[[i]],
         file = sprintf("FigCode/FigM_correlation_btw_heterogeneity_out/cor_%s_within.png",
                        ws.pairs$filename[i]),
...
for (i in 1:10) {
  saveRDS(as_plots[[i]],
          file = sprintf("FigCode/FigM_correlation_btw_heterogeneity_out/cor_%s_across.obj",
                         as.pairs$filename[i]))
  ggsave(as_plots[[i]],
         file = sprintf("FigCode/FigM_correlation_btw_heterogeneity_out/cor_%s_across.png",
                        as.pairs$filename[i]),
...
writeLines(capture.output(sessionInfo()),
           ...
           sprintf("FigCode/Fig_SessionInfo/FigM_correlation_btw_heterogeneity_%s.txt", substr(Sys.time(), 1, 10)))
